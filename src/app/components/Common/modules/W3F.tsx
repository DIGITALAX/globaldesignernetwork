      ...
      <div className="relative w-full">
        ...
        <div className="relative px-6 py-16 md:px-12 lg:px-20">
          <div className="relative mb-12 text-center">
            ...
            >
              <h2 className="relative text-5xl md:text-7xl font-bold text-gray-800">
          ...
          <div className="flex justify-center gap-2 mb-12">
            {["stats", "activity"].map((tab) => (
              <button
                ...
                className={`
                  px-6 py-3 font-semibold uppercase text-sm transition-all
                  ${
                    activeTab === tab
                ...
                <div className="flex flex-col items-center gap-2 justify-center">
                  <div className="bg-white p-12 shadow-xl border border-gray-200 max-w-lg">
                    <div className="text-gray-800 text-center">
                      <div className="text-sm font-semibold uppercase mb-4 text-gray-500">
                        {dict?.w3fTotalSupply}
                      </div>
