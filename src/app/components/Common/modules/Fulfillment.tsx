...
const Fulfillment: FunctionComponent<FulfillmentProps> = ({ dict }) => {
  return (
    <div className="relative w-full overflow-x-hidden">
      <div className="crinkled-wheatpaste wheatpaste-fold diagonal-layout poster-wrinkles w-full h-fit bg-gradient-to-br from-pink-400 via-pink-500 to-pink-600 relative">
        <div className="relative w-full h-[50rem] flex items-center justify-center">
        <div className="relative w-[85%] md:w-[65%] mid:w-[55%] xl:w-[45%] max-w-6xl h-[85%] bg-white rounded-2xl overflow-hidden shadow-2xl z-5 flex flex-col overflow-x-hidden">
          <video
          ...
          <div className="relative w-full h-fit flex flex-col md:flex-row gap-3 justify-between items-center">
            ...
            <div className="relative bottom-6 md:bottom-14 md:right-8 w-40 h-44 bg-black shadow-harsh z-5 transform -rotate-1">
