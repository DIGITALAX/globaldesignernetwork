            ...
            <div className="relative w-full h-full flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="relative w-fit h-fit flex flex-col relative z-20">
                <div className="ransom-note-typography">
                  <span className="cut-out-letter-F bg-white text-black shadow-harsh text-3xl lg:text-8xl transform rotate-3">
                    G
                  </span>
                  <span className="cut-out-letter-E bg-black text-white shadow-harsh text-3xl lg:text-5xl  transform -rotate-2">
                    L
                  </span>
                  <span className="cut-out-letter-S bg-yellow-400 text-black shadow-harsh text-3xl lg:text-5xl  transform rotate-1">
                    O
                  </span>
                  <span className="cut-out-letter-T bg-white text-black shadow-harsh text-3xl lg:text-5xl  transform -rotate-3">
                    B
                  </span>
                  <span className="cut-out-letter-I bg-pink-600 text-white shadow-harsh text-3xl lg:text-5xl transform rotate-2">
                    A
                  </span>
                  <span className="cut-out-letter-V bg-black text-white shadow-harsh text-3xl lg:text-8xl transform -rotate-1">
                    L
                  </span>
                </div>

                <div className="ransom-note-typography mt-4">
                  <span className="cut-out-letter-P bg-black text-white shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform rotate-1">
                    D
                  </span>
                  <span className="cut-out-letter-U bg-pink-600 text-white shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-3">
                    E
                  </span>
                  <span className="cut-out-letter-N bg-yellow-400 text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform rotate-2">
                    S
                  </span>
                  <span className="cut-out-letter-K bg-white text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-1">
                    I
                  </span>
                  <span className="text-5xl xl:text-7xl transform rotate-3">
                    G
                  </span>
                  <span className="cut-out-letter-A bg-yellow-400 text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform rotate-4">
                    N
                  </span>
                  <span className="cut-out-letter-L bg-white text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-2">
                    E
                  </span>
                  <span className="cut-out-letter-P bg-black text-white shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform rotate-1">
                    R
                ...
                <div className="ransom-note-typography mt-4">
                  <span className="cut-out-letter-T bg-white text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-3">
                    N
                  </span>
                  <span className="cut-out-letter-I bg-pink-600 text-white shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform rotate-2">
                    E
                  </span>
                  <span className="cut-out-letter-V bg-black text-white shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-1">
                    T
                  </span>
                  <span className="cut-out-letter-F bg-white text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform rotate-3">
                    W
                  </span>
                  <span className="cut-out-letter-E bg-black text-white shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-2">
                    O
                  </span>
                  <span className="cut-out-letter-K bg-white text-black shadow-harsh text-3xl lg:text-5xl xl:text-7xl transform -rotate-1">
                    R
