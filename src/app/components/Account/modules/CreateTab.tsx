  ...
  if (!designer) {
    return (
      <div className="p-6 text-center">
        <div className="text-lg font-bold mb-4">{dict?.noDesignerProfile}</div>
              ...
              >
                <div className="flex justify-between flex-wrap items-start mb-4 gap-4">
                  ...
                  {drop?.dropId !== "orphan" && (
                    ...
                    >
                      {deleteDropLoading === Number(drop?.dropId) ? dict?.deleting : dict?.deleteDrop}
                    </button>
                  )}
                </div>
                        ...
                        <div className="space-y-2">
                          ...
                          {canDelete && (
                            <button
                              ...
                              disabled={deleteCollectionLoading === Number(collection?.collectionId)}
                              className="w-full bg-red-600 text-white px-2 py-1 text-xs hover:bg-red-700 transition-colors disabled:opacity-50"
                            >
                              {deleteCollectionLoading === Number(collection?.collectionId)
                                ? dict?.deleting
                                : dict?.delete}
                            </button>
                          )}
